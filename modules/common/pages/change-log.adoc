...
Добавлена возможность использовать xref:user:prepare-authenticate.adoc#extensions[расширения авторизации] ЕСИА
include::platform:ROOT:partial$chunks.adoc[tags=esia-v]
и Azure.
