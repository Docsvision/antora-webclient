:link: https://github.com/Docsvision/WebClient-Samples/tree/master/ProjectTemplates/TemplateDesignerExtension
...
Ссылка на шаблон на GitHub: {link}[{name}].

.Чтобы создать расширение программы {kvr}:
. Создайте в Visual Studiofootnote:[Рекомендуется использовать Visual Studio Code {vscode-v}.] новый проект с типом TemplateDesignerExtension.
+
