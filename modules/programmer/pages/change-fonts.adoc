...
. Добавьте новые шрифты или шрифт _Roboto_ с требуемой жирностью в подпапку своего _Решения_ в `{Каталог установки {wc}}\Content`.
+
. Откройте для редактирования файл `{Каталог установки {wc}}\Content\fonts.html`.
+
[source,html]
----
