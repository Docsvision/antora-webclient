:link: https://github.com/Docsvision/WebClient-Samples/tree/master/Others/Watermark
:name: Watermark
...
. Скопировать папку `Others\Watermark\DebPackage` на Linux в каталог, где планируется выполнять сборку пакета (расположение папки значения не имеет).
