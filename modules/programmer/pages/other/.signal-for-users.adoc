...
.. Скопируйте папку `SamplesOutput\Site\Content\Modules\SignalForUsersWebExtension\` в `Путь к сайту Web-клиента\Content\Modules`.
.. Скопируйте папку `SamplesOutput\Site\Extensions\SignalForUsersExtension` в `Путь к сайту Web-клиента\Extensions`.
