...
include::./dv-web-extensions.adoc[tags=watermarkservice]
...
Разделы, посвящённые сборке, проверке и особенностям обновления аналогичны тем же разделам в документации _DVWebTool_, см. "xref:./dv-web-extensions.adoc#buildProject[]".
