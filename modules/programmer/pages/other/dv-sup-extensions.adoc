...
Полный код примера доступен в https://github.com/Docsvision/WebClient-Samples/tree/master/Others/Watermark[репозитории {dv} на GitHub], содержит методы работы с МЧД для {wc}а и для {wincl}а.
