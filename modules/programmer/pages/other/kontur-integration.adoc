:link: https://github.com/Docsvision/WebClient-Samples/tree/master/Others/KonturIntegration
:name: KonturIntegration
...
.. Скопируйте папку `SamplesOutput\Content\Modules\KonturWebExtension\` в  `Путь к сайту Web-клиента\Content\Modules`.
.. Скопируйте папку `SamplesOutput\Extensions\KonturServerExtension` в  `Путь к сайту Web-клиента\Extensions`.
