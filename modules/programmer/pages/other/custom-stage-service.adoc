:link: https://github.com/Docsvision/WebClient-Samples/tree/master/Others/CustomStageService
:name: CustomStageService
...
Пример рассчитан на версии модулей Служба {ws} и {wincl} версии 6.1 или выше.
