:link: https://github.com/Docsvision/WebClient-Samples/tree/master/ServerExtensions/DataGridControlExtension
:name: DataGridControlExtension
...
//
// ERR-6590 -- Раздел полностью не в тему. Убрать.
//
