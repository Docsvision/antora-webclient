:link: https://github.com/Docsvision/WebClient-Samples/tree/master/ServerExtensions/CreateCardDialog
...
. Скопировать каталог `SamplesOutput\Extensions\CreateCardDialogServerExtension` в каталог `Путь к сайту {wc}а\Extensions`
. Скопировать файл `SamplesOutput\Extensions\ru\CreateCardDialogServerExtension.resources.dll` в каталог `Путь к сайту {wc}а\Extensions\ru`
. Скопировать каталог `SamplesOutput\Content\Modules\CreateCardDialogWebExtension` в каталог `Путь к сайту {wc}а\Content\Modules`
