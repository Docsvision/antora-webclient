...
. Скопируйте каталог `SamplesOutput\Site\Content\Modules\TableControlWebExtension` в каталог `Путь к сайту Web-клиента\Content\Modules`.
. Скопируйте каталог `SamplesOutput\Site\Extensions\TableControlServerExtension` в каталог `Путь к сайту Web-клиента\Extensions`.
