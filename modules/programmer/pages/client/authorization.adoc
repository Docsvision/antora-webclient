:link: https://github.com/Docsvision/WebClient-Samples/tree/master/ClientScripts/TypeScript/LoginPage
:name: LoginPage
...
Данный раздел описывает расширение, которое содержит пример внедрения своего кода на страницу входа {wc}а, а именно:
...
// tag::link[]
Ссылка на пример на GitHub: {link}[{name}].
// end::link[]
