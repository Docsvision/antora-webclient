:link: https://github.com/Docsvision/WebClient-Samples/tree/master/ClientScripts/TypeScript/ExtendServerQueryData
...
На следующем шаге необходимо клонировать и заменить собственный сервис контроллера (обработчик события):
