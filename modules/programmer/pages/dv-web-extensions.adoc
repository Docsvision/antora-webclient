...
. Скопируйте папку `SamplesOutput/Site/Content/Tools\DVWebTool/Application Files/` в `{wcd}/Content/Tools/DVWebTool/`.
. Скопируйте папку `SamplesOutput/Site/Extensions/WatermarkServerExtension` в `{wcd}/Extensions`.
. Запустите *{wcs-new}*.
