...
include::log.adoc[tags=webconfig-webc]

Подробнее см. "xref:log.adoc#webc-requests[Протоколирование запросов сервера {wc}а]".

[#appserv-log]
=== Включить протоколирование запросов сервера приложений

include::log.adoc[tags=webconfig-serv]

Подробнее см. "xref:log.adoc#appserv-requests[Протоколирование запросов сервера приложений]".
...
Подробнее см. "xref:log.adoc#nlog[Протоколирование запросов с помощью NLog]".
...
Подробнее см. "xref:add-edit-formats.adoc[]".
