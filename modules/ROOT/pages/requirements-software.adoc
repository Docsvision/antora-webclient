...
* {asp-bundle}.
* {net-r} и выше для работы DVWebTool и DVSupService.
...
.Для использования простой ЭП:
* КриптоПро CSP версии {csp-v}.
* xref:engineer:ROOT:java-service.adoc[Криптосервис обслуживания ЭП] для проверки и формирования простой подписи и подписей CAdES-BES и CAdES-X Long Type 1.
