// tag::short[]
Данная возможность доступна только при установленном Microsoft Office для следующих файлов: `.doc`, `.docx`, `.docm`, `.xls`, `.xlsx`, `.xlsm`, `.ppt`, `.pptx`, `.odt` и `.ods`.
// end::short[]
