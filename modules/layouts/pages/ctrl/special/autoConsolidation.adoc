...
Элемент управления `_Автоконсолидация_` предназначен для запуска функции автоматической консолидации версий согласуемого документа. Автоконсолидация выполняется с помощью "xref:admin:preview-r7.adoc[Р7-Офис. Сервер документов]".
