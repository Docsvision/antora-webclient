...
Столбец, по которому выполняется сортировка. По умолчанию используется сортировка папки. Сортировка по убыванию работает, только если в поле _Колонка сортировки_ указано название колонки.
