...
==== Высота HTML редактора (px)

Высота элемента управления при использовании HTML редактора. Значение указывается в пикселях. Значение по умолчанию -- `200`.
...
Значение может быть указано в `%` и `vw`. Если значение не уточнено и указана только цифра, будут использоваться `px`.
